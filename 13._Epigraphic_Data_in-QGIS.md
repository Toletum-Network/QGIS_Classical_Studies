...
It is advised to download all the data from the Drive and save iyt on your local drive. Files in the could tend to get corrupted due to network failures.

### 13.2 ![Basic](https://github.com/Toletum-Network/AutumnSchool_2020/blob/master/Icons/basic.png) Starting our map
We start out with the project from the Drive.
