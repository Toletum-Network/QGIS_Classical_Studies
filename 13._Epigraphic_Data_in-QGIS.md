...
Even after our filtering we have the issue that in one location we might have multiple inscriptions. There are different ways of demonstrating this. Two of these are easily done in the **``Symbology``**.
