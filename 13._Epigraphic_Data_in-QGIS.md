...
* Base Layer: a raster from the Consortium of Ancient World Mappers (CAWM)
...
WMTS layers can be added from online resources.

We find the Consortium of Ancient World Mappers (CAWM) online base layer, the WMTS via: http://cawm.lib.uiowa.edu/index.html. At this page we also find other methods to upload their online maps for different GIS programmes.


Besides a neat base layer we need some other data to work with. Before adding the epigraphy we will add the secondary data:
* Roads
* Settlemnts
