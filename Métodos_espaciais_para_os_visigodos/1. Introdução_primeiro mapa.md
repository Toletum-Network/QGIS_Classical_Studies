...
<br>
This projection is often used for webbased mapping, such as Google. These projections are cylindrical and they have the problem that they tend to exaggerate area further from the equator:
![Mercator issue]([https://en.wikipedia.org/wiki/Mercator_projection#/media/File:Worlds_animate.gif](https://github.com/Toletum-Network/QGIS_Classical_Studies/blob/master/M%C3%A9todos_espaciais_para_os_visigodos/Images/Worlds_animate.gif))
<br>
