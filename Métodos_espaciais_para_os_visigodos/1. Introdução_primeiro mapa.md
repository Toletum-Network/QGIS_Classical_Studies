...
7. Write 'Metropolitan' in the `Label` field and in the `Filter` field enter the formula: "Council_pr"  LIKE '%Sedis%'
...
Now we have differentiated between the places that had bishops and those that were metropolitan sees. 
...
Check the Attributes of the provinces layer and decide what you want to display 
