...
4. To use the plugin just check the **``Enable``** checkbox and be sure that the _~srtm_41_19~_ layer is active (checked) in the **``Layers``** panel.
