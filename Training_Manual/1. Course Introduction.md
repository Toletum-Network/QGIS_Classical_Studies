...
Download the prepared dataset from the [Training data repository](https://drive.google.com/drive/folders/1S8lygvwGiy5UBM8SGo_LSB1tShKqPbV2) and unzip the file. All the necessary data are provided in the _exercise_data_ folder. 

**! Note** The Training data only uses the data for the Iberian Peninsula. The above listed datasets include all areas considered to be the Ancient World.
