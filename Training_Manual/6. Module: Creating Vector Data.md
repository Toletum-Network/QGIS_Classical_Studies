...
Click on the selectRectangle Select Features button in the Attributes Toolbar.
...
When done editing, click the toggleEditing Toggle Editing button to get out of edit mode, and save your edits.
...
If the roads layer is not in your map, then add it from the GeoPackage file training-data.gpkg included in the exercise_data folder of the training data you downloaded.

Activate edit mode.

Since you are working with a line feature, click on the addLineFeature Add Line button to initiate line digitizing mode.

One at a time, digitize the path and the track on the routes layer. Try to follow the routes as accurately as possible, adding additional points along corners or turns.
...
Save your edits and toggle off editing mode by pressing the toggleEditing Toggle Editing button.
