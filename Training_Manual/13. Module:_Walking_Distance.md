...
If you want to learn more you can always use the full [QGIS Training Manual](https://docs.qgis.org/3.10/en/docs/training_manual/index.html). Or try the workshop aimed at epigraphic studies: [Epigraphic Data in QGIS](https://github.com/Toletum-Network/QGIS_Classical_Studies/blob/master/I._Epigraphic_Data_in-QGIS.md#i-epigraphic-data-in-qgis)
