...
For this exercise you will use maps from the already scanned versions of Anuario Arqueológico de Andalucía, you can find them in the data folder  **_Module 10/Exercise_data/Raster_**.
