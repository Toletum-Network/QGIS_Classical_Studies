...
**``!Note``**
Some maps have added coordinates this makes georeferencing a lot easier. In the example we use the coordinates are on the sides of the map, from there we were able to position the crosshairs. 
