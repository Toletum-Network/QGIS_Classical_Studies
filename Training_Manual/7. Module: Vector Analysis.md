...
1. Use the _routes_ and _rivers_ buffer layers as **``Input layer``** and **``Overlay layer``**, save the file  in **``Intersection``** with **``Label name``** _routes_rivers_intersect. Leave the rest as suggested (default).
