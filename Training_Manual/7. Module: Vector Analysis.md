...
1. Add another vector layer to your map which has the data for Spain only. You will find it in the Module 7 _**exercise_data**_ as _**L07_Peiades_IP_Places_(WGS84)**_.
...
1. Right-click on the _**L07_Pleiades_IP_Places__(WGS84)**_ layer in the **``Layers``** panel
