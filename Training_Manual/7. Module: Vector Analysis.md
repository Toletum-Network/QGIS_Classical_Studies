...
2. Then type _`world`_ in the **``Coordinate``** field, which is in the _Statusbar_ along the bottom of the screen. A **``World Map``** Layer will be added to the empty project.
