...
[Additional eductional material](https://drive.google.com/drive/u/0/folders/12PU6W50dCzEau_1PNXaGbd8vZNCVWPNz?ths=true)
...
1. Right-click on the _L07_Peiades_IP_Places__(WGS84)_ layer in the **``Layers``** panel
...
4. Navigate to _exercise_data/_ and specify the name of the new layer as _L07_Peiades_IP_Places__(UTM 30N)_.
...
The first three sets of data are available in the dataset you have been using throughout this manual and can be found in the Module 7 exercise data folder. Only the layer _L07_BTN100_rivers_ has to be added the exercise data.
...
2. In the Module 7 exercise data, you will find the datasets we will use in this chapter. You can also use the data you have been suing throughout the course:
...
Use the same approach as above and create a buffer for the rivers.
Now your map will look something like this:
...
[Check your results](https://github.com/Toletum-Network/AutumnSchool_2020/blob/master/Training_Manual/Answer_Sheet/Answer_sheet.md#726--try-yourself-distance-from-cities)
...
![7.3.4 B](https://github.com/Toletum-Network/AutumnSchool_2020/blob/master/Screenshots/7.3.5%20B%20service_area_result.png)
