...
You can order your layers in the Layer Panel by dragging them (left click hold and drag up or down). If the _**L02_BA_RomanProvinces_AD_100**_ covers your other layers, drag it to the lowest postion in the Layers Panel
