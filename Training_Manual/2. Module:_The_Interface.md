# 2. Module: The Interface
 [Additional eductional material](https://drive.google.com/drive/u/0/folders/1fpvoGvv48iNMjbaxCSrV3fS9DB_Mkvfu?ths=true)
...
Note
Before starting this exercise, [QGIS 3.10 LTR](https://www.qgis.org/en/site/) must be installed on your computer. Also, you should have downloaded the [sample data](https://drive.google.com/drive/folders/1AlBkPg3Aa8Mpv_AXBNMmpuoK_nqtRE5G?usp=sharing) and prepared QGIS project _GIS COURSE 25830 NAME.qgz_ to use.
...
1. Open the QGIS project by double clicking he project _GIS COURSE 25830 NAME.qgz_. You will have a new, blank map.
...
3. Load the _provinces.shp_ vector dataset:
