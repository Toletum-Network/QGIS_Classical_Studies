...
Note
Before starting this exercise, [QGIS 3.10 LTR](https://www.qgis.org/en/site/) must be installed on your computer. Also, you should have downloaded the [exercise data](https://drive.google.com/drive/folders/1AlBkPg3Aa8Mpv_AXBNMmpuoK_nqtRE5G?usp=sharing) for module 2 to your local drive and prepared QGIS project _GIS COURSE 25830 NAME.qgz_ to use.
...
3. Load the _L02_BA_RomanProvinces_AD_100.shp_ vector dataset:
...
* Select the [**_L02_BA_RomanProvinces_AD_100.shp_**] file in your training directory.
