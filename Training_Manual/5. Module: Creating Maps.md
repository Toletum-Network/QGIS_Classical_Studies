...
2. Click the ![lockItems]()_Lock Selected Items_ button in the Actions Toolbar.

**``! Note``**

``Click the ![unlockAll]()_Unlock All Items_ button in the Actions Toolbar to be able to edit the items again.``
