...
[Additional eductional material](https://drive.google.com/drive/u/0/folders/1wLt5WdzVdGDoNw6PPaYNebwdszg393A8?ths=true)
...
You can do the same with items within a layer. Delete the **``rivers``** _1_, _2_ and the empty category.

5. Repeat this with all elements that are not visible within the map.
