...
Click on the Project ‣ Layout Manager… menu entry to open this tool. You’ll see a blank Layout manager dialog appear.

../../../_images/layout_manager_dialog.png
Under New from Template, select Empty layout and press the Create… button.

Give the new layout the name of Swellendam and click OK.
...
Right-click on the sheet in the central part of the layout window and choose Page properties… in the context menu.

Check that the values in the Item Properties tab are set to the following:
