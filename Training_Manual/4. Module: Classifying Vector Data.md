...
Labels are a good way to communicate information such as the names of individual places, but they can’t be used for everything. For example, let us say that someone wants to know what each _landuseAlmanzora_  area is used for. Using labels, you would get this:
