...
3. Click on the **L04_E2KC_cities** layer in the **Layers panel** so that it is highlighted
...
6. Select _canon_name_ from the Value list:
...
Use the knowledge you gained above to classify the **rivers** layer by the _importance_ field and the **roads** layer by the _CLASS_ field.
