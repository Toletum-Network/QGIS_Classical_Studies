...
No use **``Vector ‣ Geoprocessing Tools ‣ Difference``** again, choose the buffer layer we edited already as your _**Input layer**_ and your *suitableVector* layer as _**Overlay layer**_ and activate _**Selected features only**_ here.
