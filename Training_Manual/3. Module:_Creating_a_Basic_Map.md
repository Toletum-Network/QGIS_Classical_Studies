...
This is good stuff so far, but there’s more to a layer’s symbology than just its color. Next we want to eliminate the lines between the different inland water areas.
1. Open the **Layer Properties** window for the **L03_AWMC_inland_water_edits** layer.
...
Now the **L03_AWMC_inland_water_edits** layer won’t have any lines between areas.
