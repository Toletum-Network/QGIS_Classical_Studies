...
It will show you a table with more data about the **roads** layer. This is the layer’s **Attribute table**. A row is called a _record_, and represents a road _feature_. A column is called a _field_, and represents a property of the road. Cells show _attributes_.
